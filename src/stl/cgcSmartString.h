...
namespace cgc{
	...
	public:
		...
		std::string::size_type find_last_of(char data, std::string::size_type off=0) const {return m_sData->find_last_of(data, off);}
		std::string::size_type find_last_of(const char* data, std::string::size_type off=0) const {return m_sData->find_last_of(data, off);}
		...
		std::string::size_type find_last_of(const std::string& data, std::string::size_type off=0) const {return m_sData->find_last_of(data, off);}
		std::string::size_type find_last_of(const cgcSmartString& data, std::string::size_type off=0) const {return m_sData->find_last_of(data.c_str(), off, data.size());}
		std::string::size_type find_last_not_of(char data, std::string::size_type off=0) const {return m_sData->find_last_not_of(data, off);}
		std::string::size_type find_last_not_of(const char* data, std::string::size_type off=0) const {return m_sData->find_last_not_of(data, off);}
		...
		std::string::size_type find_last_not_of(const std::string& data, std::string::size_type off=0) const {return m_sData->find_last_not_of(data, off);}
		std::string::size_type find_last_not_of(const cgcSmartString& data, std::string::size_type off=0) const {return m_sData->find_last_not_of(data.c_str(), off, data.size());}
